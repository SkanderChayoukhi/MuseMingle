    ...
    <div class="main-body">
      <div class="card mb-3">
        <div class="card-body">
          <div class="row">
            <div class="col-sm-3">
              <h6 class="mb-0">nom_tab</h6>
            </div>
            <div class="col-sm-9 text-secondary"><?php echo $user["nom_tab"] ?></div>
          </div>
          <hr />
          <div class="row">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9 text-secondary"><?php echo $user["prix"] ?></div>
          </div>
          <hr />
          <div class="row">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9 text-secondary"><?php echo $user["categorie"] ?></div>
          </div>
          <hr />
          <div class="row">
            <div class="col-sm-3">
          ...
          <div class="row">
            ...
            <div class="col-sm-9 text-secondary">
              <?php echo $user["artiste"]  ?>
            </div>
          </div>
          <div class="row">
            <div class="col-sm-3">
              <h6 class="mb-0">description_artiste</h6>
            </div>
            <div class="col-sm-9 text-secondary">
              <?php echo $user["description_artiste"]  ?>
            </div>
          </div>
          <hr />
          <hr />
